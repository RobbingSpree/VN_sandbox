...
function csv_to_struct(_filename){
	/// @desc csv_to_struct
	/// @param file
	//  
	...
	//	edited from script by Juju Adams by Robert Tester
	//  @jujuadams

	var _force_strings    = false;	 //forces all values to be strings
	var _cell_delimiter   = chr(44); //comma
	var _string_delimiter = chr(34); //double-quote
	var _newline_alt      = false;	 //mac defined newline character compatability flag
	...
	//  arg2   string   The delimiter used to separate cells. Defaults to a comma
	//  arg3   string   The delimiter used to define strings in the CSV file. Defaults to a double-quote
	//  arg4   bool     Newline compatibility mode for Mac (0xA). Defaults to Windows standard newline (0xDA)
	//  
	//  (c) Juju Adams 26th May 2017
	//  @jujuadams
